...
const couchdbutil = require('../../../RE-Project/fabric-samples/off_chain_data/couchdbutil.js');
const blockProcessing = require('../../../RE-Project/fabric-samples/off_chain_data/blockProcessing.js');

const config = require('../../../RE-Project/fabric-samples/off_chain_data/config.json');
