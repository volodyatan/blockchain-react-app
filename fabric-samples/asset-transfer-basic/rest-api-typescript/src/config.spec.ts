...
describe('Config values', () => {
  ...
  describe('logLevel', () => {
    it('defaults to "info"', () => {
      const config = require('../../../../../RE-Project/fabric-samples/asset-transfer-basic/rest-api-typescript/src/config');
    ...
    it('throws an error when the "LOG_LEVEL" environment variable has an invalid log level', () => {
      ...
      expect(() => {
        require('../../../../../RE-Project/fabric-samples/asset-transfer-basic/rest-api-typescript/src/config');
      }).toThrow(
