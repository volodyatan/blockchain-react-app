...
const AssetTransfer = require('../../../../../RE-Project/fabric-samples/asset-transfer-basic/chaincode-custom/lib/assetTransfer.js');
...
describe('Asset Transfer Basic Tests', () => {
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let assetTransfer = new AssetTransfer();
            try {
                await assetTransfer.CreateAsset(transactionContext, asset.ID, asset.Color, asset.Size, asset.Owner, asset.Value);
    ...
    describe('Test GetAllAssets', () => {
        it('should return success on GetAllAssets', async () => {
            ...
            let expected = [
                {Record: {ID: 'asset1', Color: 'blue', Size: 5, Owner: 'Robert', Value: 100}},
                {Record: {ID: 'asset2', Color: 'orange', Size: 10, Owner: 'Paul', Value: 200}},
                {Record: {ID: 'asset3', Color: 'red', Size: 15, Owner: 'Troy', Value: 300}},
                {Record: {ID: 'asset4', Color: 'pink', Size: 20, Owner: 'Van', Value: 400}}
            ];
